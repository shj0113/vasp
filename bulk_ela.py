...
params=dict(NELMIN=6,EDIFFG=-0.01, ISMEAR=0,EDIFF=1E-6,LASPH='True',LREAL='Auto',IBRION=2,NSW=200, ALGO='Normal') 
...
kparams=dict(reciprocal_density=1000) #This is density of k-points. 100 is enough usually.

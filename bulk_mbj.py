...
params=dict(LASPH='True',ALGO = 'Fast',NSW=800, EDIFFG=-0.01, EDIFF=1E-8, NPAR=4, ISMEAR=0,LREAL='False',LWAVE='True',NELM=5000,ISPIN=1,LVTOT='True') #This is parameters for incar

...
#                die "negative occupation found in band $j of k-point $i\n"
                    ...
                    $homo = $bandenergy;
					$homonumber = $bandnumber;
                }elsif (defined $lumo) {
                        # if the lumo has been defined, keep reading until the end of this k-point
                    }else{
                    $lumo = $bandenergy;    
					$lumonumber = $bandnumber;
            }
            $j++;
        }
    ...
    if ($spinupHOMO == $spindownHOMO) {
        ...
        print "the k-point of $spinupHOMOkx $spinupHOMOky $spinupHOMOkz (bandnumber: $spinupHOMOn)\n";
        print "\n";
        print "The bottom of the conduction band is $spinupLUMO eV and it occurs at\n";
        print "the k-point of $spinupLUMOkx $spinupLUMOky $spinupLUMOkz (bandnumber: $spinupLUMOn)\n";
        print "\n";
        ...
        print "the k-point $topkx, $topky, $topkz (band number:$topn)\n";
        print " \n";
        $gap = $spinupLUMO - $top;
        print "The bottom of the conduction band is $spinupLUMO eV and it occurs at\n";
        print "the k-point $spinupLUMOkx $spinupLUMOky $spinupLUMOkz (band number:$spinupLUMOn)\n";
        print "\n";
...
#                die "negative occupation found in band $j of k-point $i\n"
    ...
    print "The top of the valence band is $spinupHOMO eV and it occurs at\n";
    print "the k-point of $spinupHOMOkx $spinupHOMOky $spinupHOMOkz (band number: $spinupHOMOn)\n";
    print "\n";
    print "The bottom of the conduction band is $spinupLUMO eV and it occurs at\n";
    print "the k-point of $spinupLUMOkx $spinupLUMOky $spinupLUMOkz (band number: $spinupLUMOn)\n";
    print "\n";
    $gap = $spinupLUMO - $spinupHOMO;
    if ($spinupHOMOkx == $spinupLUMOkx && $spinupHOMOky == $spinupLUMOky && $spinupHOMOkz == $spinupHOMOkz) {
        $direction = "a direct";
...
print "\n";
#print $spinupLUMOn, $spinupHOMOn, $spindownLUMOn, $spindownHOMOn;
#
#


open(my $fh, ">emcinput_n");
print $fh "$spinupLUMOkx $spinupLUMOky $spinupLUMOkz ! K-points in the reciprocal crystal coord\n";
print $fh "0.01  ! stepsize in 1/Bohr units (1 float)\n";
print $fh "$spinupLUMOn !band number \n";
print $fh "V\n";
...
open(my $fh, ">emcinput_p");
print $fh "$spinupHOMOkx $spinupHOMOky $spinupHOMOkz ! K-points in the reciprocal crystal coord\n";
print $fh "0.01  ! stepsize in 1/Bohr units (1 float)\n";
print $fh "$spinupHOMOn !band number \n";
print $fh "V\n";

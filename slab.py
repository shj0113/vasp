...
params=dict(LASPH=True,PREC='Normal',ALGO='Normal',ISTART = 1, LREAL ='Auto', ENCUT=520, LCHARG='False',NPAR=4, ISIF=2, ISMEAR=0, SIGMA=0.05, NELM=100, NELMIN=6, EDIFF=1E-08,  NSW=600, IBRION=2, EDIFFG=-0.01,ISPIN=1) #only relaxation
...
userset.write_input('.')
import os
#os.system('awk \'NR==24{$3="1"}1\' KPOINTS > KPOINTS~')

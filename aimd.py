...
params=dict(EDIFF=0.001, EDIFFG=-0.01,ISMEAR=0, IBRION=0, MDALOG=2, ISIF=2, SMASS=1, SIGMA=0.1, LREAL='Auto', ALGO='VeryFast', PREC='Low', ISYM=0,TEBEG=3000,TEEND=5000,NSW=5200,POTIM=2,NPAR=4)
